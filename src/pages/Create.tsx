...
import { DurationTabs, getDurationSeconds, type DurationMode } from '@/components/create/DurationTabs';
import { SpeedSelector, type SpeedValue } from '@/components/create/SpeedSelector';
